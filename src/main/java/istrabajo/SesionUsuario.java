...
/**
 * Clase que sigue el patrón Singleton para almacenar los datos de la sesión del
 * usuario que la inicie.
 */
public class SesionUsuario {
    ...
    /**
     * Utilizado para almacenar los datos de la sesión del usuario. Utilizado
